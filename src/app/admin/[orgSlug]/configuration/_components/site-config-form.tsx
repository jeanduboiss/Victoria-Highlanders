...
export function SiteConfigForm({ orgSlug, config }: SiteConfigFormProps) {
    const t = useTranslations('admin.pages.configuration.general')
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                <div className="space-y-4">
                    <h2 className="text-base font-semibold">{t('clubInfo')}</h2>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder={t('taglinePlaceholder')} {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                ...
                <div className="space-y-4">
                    <h2 className="text-base font-semibold">{t('colors')}</h2>
                    <div className="grid grid-cols-2 gap-4">
                        <FormField
                            control={form.control}
                            name="primaryColor"
                ...
                <div className="space-y-4">
                    <h2 className="text-base font-semibold">{t('visibility')}</h2>
                    <div className="grid grid-cols-2 gap-4">
                        <FormField
                            control={form.control}
                            name="hideResults"
                ...
                <div className="space-y-4">
                    <h2 className="text-base font-semibold">{t('seo')}</h2>
                    <FormField
                        control={form.control}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel>{t('metaDesc')}</FormLabel>
                                <FormControl>
                                    <Input placeholder={t('metaDescPlaceholder')} {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
